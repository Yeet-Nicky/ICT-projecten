import os  # Voor het uitvoeren van systeemopdrachten zoals Rclone
import weatherhat
import time
...
while running:
    ...
    try:
        ...
        onedrive_folder = "OneDrive:/2024-2025/ICT projecten/Programma's/"
        try:
            os.system(f"rclone copy {local_file_path} {onedrive_folder}")
            print("Bestand succesvol geüpload naar OneDrive.")
        except Exception as e:
            print(f"Upload naar OneDrive mislukt: {e}")
